...
Bevor man die Entwicklungsumgebung verwenden kann, müssen eine Datenbank (MongoDB 5.0.8) sowie eine \enquote{MoM} (RabbitMQ 3.10.2) mithilfe von Docker Compose (verwendbar mit Docker Desktop 4.8.2) gestartet werden.
